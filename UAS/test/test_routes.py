...
def create_test_cart(cart_id):
    cart = Cart(id=cart_id, coupon_code='SAMPLE_COUPON', shipping_fee=100000.0, subtotal=25000.0, grand_total=125000.0)
    cart_item = CartItem(product_id=1, qty=2, item_price=25000.0)
